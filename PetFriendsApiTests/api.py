...
class PetFriends:
    ...
    def create_pet_simple(self, auth_key: json, name: str, animal_type: str,
                    age: str) -> json:
        """Метод отправляет (постит) на сервер данные о создаваемом питомце и возвращает статус
        запроса на сервер и результат в формате JSON с данными созданного питомца"""
    ...
    def set_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        ...
        """Метод добавляет на сервер фото существующего питомца и возвращает статус
        запроса на сервер"""
